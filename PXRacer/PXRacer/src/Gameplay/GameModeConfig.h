        ...
        // Difficulty levels for Endless mode
        ...
        // Endless mode configuration values
        ...
        enum class CampaignTaskType {
            ...
            BeatTime,           // Complete under a certain time
            BeatLapTime,        // Best lap under a time limit
            NoSpinouts,         // Complete without spinning
            StayOnTrack,        // Complete without leaving the road
            TopSpeed,           // Reach a certain maximum speed
            AverageLapTime,     // Average lap time under a limit
            PerfectLaps,        // Complete N perfect laps
            CompleteLaps,       // Complete N laps
            NoDamage,           // Complete without damage
            CollectPickups      // Collect N pickups
        };
        ...
        // Campaign track difficulty levels
        ...
        struct CampaignTrackData {
            ...
            int selectedTaskIndex;          // Currently selected task (-1 = none)
            float bestTime;
            ...
            // Returns how many tasks are required to complete the circuit
            ...
            // Checks if the circuit is complete (all required tasks are done)
        ...
        public:
            static std::vector<CampaignTrackData> getTracks() {
                return {
                    ...
                    // Medium tracks (2 tasks required)
        ...
        // Bakcward compatibility aliases
